 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:9000/Admin?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICE_QNAME = new QName("http://services/", "AdminService");
    ...
    public Admin getAdminPort() {
        return super.getPort(new QName("http://services/", "AdminPort"), Admin.class);
    }
    ...
    public Admin getAdminPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "AdminPort"), Admin.class, features);
    }
